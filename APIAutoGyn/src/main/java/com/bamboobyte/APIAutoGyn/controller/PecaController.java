...
import com.bamboobyte.APIAutoGyn.service.PecaService;
import com.bamboobyte.APIAutoGyn.dto.CadastrarPecaDTO;
import com.bamboobyte.APIAutoGyn.dto.AtualizarPecaDTO;
import com.bamboobyte.APIAutoGyn.valiForm.MensagemErro;
...
public class PecaController {
    ...
    public ResponseEntity<?> adicionarEstoque(@PathVariable Long idPeca, @RequestParam Integer quantidade)
            throws SQLException {
        ...
        if (peca.getQuantidadeEstoque() + quantidade < 0) {
            return ResponseEntity.badRequest()
                    .body(new MensagemErro("Não é possível abaixar o estoque para menos que zero."));
        }
    ...
    public ResponseEntity<?> atualizarPeca(@PathVariable Long idPeca, AtualizarPecaDTO atualizarPeca)
            throws SQLException {
