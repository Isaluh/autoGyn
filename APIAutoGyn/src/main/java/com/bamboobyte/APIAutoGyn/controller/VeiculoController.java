...
import com.bamboobyte.APIAutoGyn.service.VeiculoService;
...
public class VeiculoController {
    ...
    public ResponseEntity<?> atualizarVeiculo(@PathVariable String placa, AtualizarVeiculoDTO atualizarVeiculo)
            throws SQLException {
