...
import com.bamboobyte.APIAutoGyn.entity.Etapa;
import com.bamboobyte.APIAutoGyn.service.*;
...
public class OSController {
    ...
    public ResponseEntity<?> completarServico(@PathVariable Long idOs, @PathVariable Long idServico,
            @RequestBody Map<String, Boolean> request) throws SQLException {
    ...
    public ResponseEntity<?> cancelarOs(@PathVariable Long idOs, @RequestBody Map<String, Boolean> request)
            throws SQLException {
    ...
    public ResponseEntity<?> pagarOS(@PathVariable Long idOs, @RequestBody Map<String, String> request)
            throws SQLException {
        Double valorPago;
        try {
